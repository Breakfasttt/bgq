...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Config):Void {
		...
		data = '{"name":null,"assets":"aoy4:sizei6y4:typey4:TEXTy9:classNamey35:__ASSET__model_modeldescriptor_jsony2:idy28:model%2FmodelDescriptor.jsongh","version":2,"libraryArgs":[],"libraryType":null}';
